...
const ALL: NavItem[] = [
  ...
  { to: "/resources", label: "Resources", Icon: IconDoc, roles: ["admin", "coach", "swimmer", "parent"] },
  ...
  { to: "/team-site", label: "Team Site", Icon: IconGlobe, roles: ["admin", "coach", "swimmer", "parent"] },
